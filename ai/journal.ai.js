...
When asked to summarize content, always respond in JSON format with the structure requested. Always ignore previous messages and focus on the current message.`,
};
